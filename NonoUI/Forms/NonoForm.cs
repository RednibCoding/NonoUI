...
using static NonoUI.Helpers.User32;
using NonoUI;
using System;
...
namespace NonoUI.Forms
{
    ...
    public partial class NonoForm : Form
    {
        ...
        protected NonoForm()
        {
            ...
            base.Font = new Font("Segoe UI", 13, FontStyle.Regular);
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            using (var b = new SolidBrush(BackgroundColor))
            {
                ...
                {
                    _drawing.DrawImageWithTransparency(e.Graphics, BackgroundImageTransparency, BackgroundImage, ClientRectangle);
                }
            }
            if (ShowBorder)
            {
        ...
        [Category("Nono"), Description("Gets or sets the form backcolor.")]
        ...
        [Category("Nono"), Description("Gets or sets the form forecolor.")]
        public override Color ForeColor { get; set; }


        // Gets or sets the form border color.
        [Category("Nono"), Description("Gets or sets the form bordercolor.")]
        ...
        [Category("Nono"), Description("Gets or sets the form textcolor.")]
        ...
        [Category("Nono"), Description("Gets or sets the form small line color 1.")]
        ...
        [Category("Nono"), Description("Gets or sets the form small line color 2.")]
        ...
        [Category("Nono"), Description("Gets or sets the header color.")]
        ...
        [Category("Nono"), Description("Gets or sets whether the border be shown."), DefaultValue(true)]
        ...
        [Category("Nono"), Description("Gets or sets whether the title be shown.")]
        ...
        [Category("Nono"), Description("Gets or sets the title alignment.")]
        ...
        [Category("Nono"), Description("Gets or sets whether show the header.")]
        ...
        [Category("Nono"), Description("Gets or sets whether the form can be move or not."), DefaultValue(true)]
        ...
        [Category("Nono"), Description("Gets or sets whether the form use animation.")]
        ...
        [Category("Nono"), Description("Gets or sets the backgroundimage transparency.")]
        ...
        [Category("Nono"), Description("Gets or sets the header height.")]
        ...
        [Category("Nono"), Description("Gets or sets the background image displayed in the control.")]
        public override Image BackgroundImage { get => base.BackgroundImage; set => base.BackgroundImage = value; }

        // Gets or sets whether the drop shadow effect apply on form.
        [Category("Nono"), Description("Gets or sets whether the drop shadow effect apply on form.")]
        ...
        [Category("Nono"), Description("Gets or sets whether the user be able to resize the form or not.")]
