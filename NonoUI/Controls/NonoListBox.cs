...
namespace NonoUI.Controls
{
    ...
    {
        Color _itemBackgroundColor = Color.White;
        Color _selectedItemBackgroundColor = Color.FromArgb(255, 128, 128, 255);
        ...
        private void on_DrawItem(object? sender, DrawItemEventArgs e)
        {
            ...
            var backBrush = ((e.State & DrawItemState.Selected) == DrawItemState.Selected) ? new SolidBrush(_selectedItemBackgroundColor) : new SolidBrush(_itemBackgroundColor);
